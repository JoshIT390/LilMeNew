      ...
      <div class="content-wrapper">
		...
		<div class="row">
			...
			<div class="small-box bg-aqua">
                ...
                <a href="showChild.jsp?group=${1}" class="small-box-footer">View Lunch Group<i class="fa fa-arrow-circle-right"></i></a>
			</div>
			...
			<div class="small-box bg-yellow">
                ...
                <a href="showChild.jsp?group=${2}" class="small-box-footer">View Lunch Group<i class="fa fa-arrow-circle-right"></i></a>
			</div>
			</div></div>
			<div class="row">
            <div class="col-lg-3 col-xs-6">
			<div class="small-box bg-green">
                ...
                <a href="showChild.jsp?group=${3}" class="small-box-footer">View Lunch Group<i class="fa fa-arrow-circle-right"></i></a>
			</div>
			...
			<div class="small-box bg-red">
                ...
                <a href="showChild.jsp?group=${4}" class="small-box-footer">View All Children<i class="fa fa-arrow-circle-right"></i></a>
			</div>
		  </div></div>
